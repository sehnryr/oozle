...
void
BitknitLiteral_Adaptive (BitknitLiteral *model, u_int32_t sym)
{
  size_t i;
  u_int32_t sum;
  u_int16_t *p, *p_end;
...
u_int32_t
BitknitLiteral_Lookup (BitknitLiteral *model, u_int32_t *bits)
{
...
void
BitknitDistanceLsb_Adaptive (BitknitDistanceLsb *model, u_int32_t sym)
{
  size_t i;
  u_int32_t sum;
  u_int16_t *p, *p_end;
...
u_int32_t
BitknitDistanceLsb_Lookup (BitknitDistanceLsb *model, u_int32_t *bits)
{
  u_int32_t masked = *bits & 0x7FFF;
...
void
BitknitDistanceBits_Adaptive (BitknitDistanceBits *model, u_int32_t sym)
{
  size_t i;
  u_int32_t sum;
  u_int16_t *p, *p_end;
...
u_int32_t
BitknitDistanceBits_Lookup (BitknitDistanceBits *model, u_int32_t *bits)
{
  u_int32_t masked = *bits & 0x7FFF;
  size_t sym = model->lookup[masked >> 9];
  sym += masked > model->a[sym + 1];
...
static void
BitknitCopyLongDist (u_int8_t *dst, size_t dist, size_t length)
{
...
static void
BitknitCopyShortDist (u_int8_t *dst, size_t dist, size_t length)
{
  const u_int8_t *src = dst - dist;
  if (dist >= 4)
    {
...
size_t
Bitknit_Decode (const u_int8_t *src, const u_int8_t *src_end, u_int8_t *dst,
                u_int8_t *dst_end, u_int8_t *dst_start, BitknitState *bk)
{
