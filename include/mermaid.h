...
int32_t Mermaid_DecodeFarOffsets (const u_int8_t *src, const u_int8_t *src_end,
                                  ...
                                  int64_t offset);
void Mermaid_CombineOffs16 (u_int16_t *dst, size_t size, const u_int8_t *lo,
                            const u_int8_t *hi);
bool Mermaid_ReadLzTable (int32_t mode, const u_int8_t *src,
                          const u_int8_t *src_end, u_int8_t *dst,
                          int32_t dst_size, int64_t offset, u_int8_t *scratch,
                          u_int8_t *scratch_end, MermaidLzTable *lz);
const u_int8_t *Mermaid_Mode0 (u_int8_t *dst, size_t dst_size,
                               u_int8_t *dst_ptr_end, u_int8_t *dst_start,
                               const u_int8_t *src_end, MermaidLzTable *lz,
                               int32_t *saved_dist, size_t startoff);
const u_int8_t *Mermaid_Mode1 (u_int8_t *dst, size_t dst_size,
                               u_int8_t *dst_ptr_end, u_int8_t *dst_start,
                               const u_int8_t *src_end, MermaidLzTable *lz,
                               int32_t *saved_dist, size_t startoff);
bool Mermaid_ProcessLzRuns (int32_t mode, const u_int8_t *src,
                            const u_int8_t *src_end, u_int8_t *dst,
                            size_t dst_size, u_int64_t offset,
                            u_int8_t *dst_end, MermaidLzTable *lz);
int32_t Mermaid_DecodeQuantum (u_int8_t *dst, u_int8_t *dst_end,
                               u_int8_t *dst_start, const u_int8_t *src,
                               const u_int8_t *src_end, u_int8_t *temp,
                               u_int8_t *temp_end);
