...
bool Kraken_ReadLzTable (int32_t mode, const u_int8_t *src,
                         const u_int8_t *src_end, u_int8_t *dst,
                         int32_t dst_size, int32_t offset, u_int8_t *scratch,
                         u_int8_t *scratch_end, KrakenLzTable *lztable);
bool Kraken_ProcessLzRuns_Type0 (KrakenLzTable *lzt, u_int8_t *dst,
                                 u_int8_t *dst_end, u_int8_t *dst_start);
bool Kraken_ProcessLzRuns_Type1 (KrakenLzTable *lzt, u_int8_t *dst,
                                 u_int8_t *dst_end, u_int8_t *dst_start);
