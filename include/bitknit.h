...
u_int32_t BitknitDistanceLsb_Lookup (BitknitDistanceLsb *model,
                                     u_int32_t *bits);
u_int32_t BitknitDistanceBits_Lookup (BitknitDistanceBits *model,
                                      u_int32_t *bits);

size_t Bitknit_Decode (const u_int8_t *src, const u_int8_t *src_end,
                       u_int8_t *dst, u_int8_t *dst_end, u_int8_t *dst_start,
                       BitknitState *bk);
